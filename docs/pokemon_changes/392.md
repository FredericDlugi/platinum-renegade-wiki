...
36    | Vacuum Wave   | 40    | 100%     | 30  | ![][fighting] {: data-sort="fighting"} | ![][special] {: data-sort="special"}   | Inflicts regular damage with no additional effect.
41    | Torment       | -     | 100%     | 15  | ![][dark] {: data-sort="dark"}         | ![][status] {: data-sort="status"}     | Prevents the target from using the same move twice in a row.
...
51    | Slack Off     | -     | -        | 10  | ![][normal] {: data-sort="normal"}     | ![][status] {: data-sort="status"}     | Heals the user by half its max HP.
56    | Flare Blitz   | 120   | 100%     | 15  | ![][fire] {: data-sort="fire"}         | ![][physical] {: data-sort="physical"} | User takes 1/3 the damage inflicted in recoil.  Has a 10% chance to burn the target.
...
TM60       | Drain Punch [^1] | 75    | 100%     | 10  | ![][fighting] {: data-sort="fighting"} | ![][physical] {: data-sort="physical"} | Drains half the damage inflicted to heal the user.
