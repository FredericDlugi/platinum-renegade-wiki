...
!!! note
    This Pokémon can be obtained through a special event. Find out more [here](../../special_events/#manaphy).
...
---   | ---             | ---   | ---      | --- | ---                                  | ---                                    | ---
1     | Heart Swap      | -     | -        | 10  | ![][psychic] {: data-sort="psychic"} | ![][status] {: data-sort="status"}     | User and target swap stat changes.
1     | Tail Glow       | -     | -        | 20  | ![][bug] {: data-sort="bug"}         | ![][status] {: data-sort="status"}     | Raises the user's Special Attack by three stages.
